...
namespace TP_WEB.Models
{
    public class BaseDeDonnees
    {
        ...
        public BaseDeDonnees()
        {
            ...
            {
                // TODO: Changer les stats de base totaux
                new Personnage() { Id = 1, IdParent = 1, Nom = "Lyn", StatsDeBaseTotaux = 101, PersonnageVedette = true, ChaineClasses = "Lord,Blade Lord", ChaineArmesUtilisees = "Épée,Arc", Citation = "As if I'd lose!", SourceImagePrincipal = "Fanart par kaejunni.",  LienSourceImage = "https://danbooru.donmai.us/posts/3292291" },

                new Personnage() { Id = 2, IdParent = 1, Nom = "Sain", StatsDeBaseTotaux = 101,PersonnageVedette = false, ChaineClasses = "Cavalier,Paladin", ChaineArmesUtilisees = "Lance,Épée,Hache", Citation = "I won't hold back! This is for all the lovely ladies I've yet to meet!!", SourceImagePrincipal = "Artwork pour le jeu Fire Emblem Cipher par Nekobayash.",  LienSourceImage = "https://fireemblem.fandom.com/wiki/Sain/Gallery?file=B07-014N_artwork.png" },

                new Personnage() { Id = 3, IdParent = 1, Nom = "Kent", StatsDeBaseTotaux = 101, PersonnageVedette = false, ChaineClasses = "Cavalier,Paladin", ChaineArmesUtilisees = "Épée,Lance,Hache", Citation = "I will gladly volunteer to protect Lycia with my life.", SourceImagePrincipal = "Artwork #4 officiel de Fire Emblem 7 venant du jeu, découpé sur Kent.",  LienSourceImage = "https://serenesforest.net/blazing-sword/miscellaneous/cgs/" },

                new Personnage() { Id = 4, IdParent = 1, Nom = "Wallace", StatsDeBaseTotaux = 101,PersonnageVedette = false, ChaineClasses = "Knight,General", ChaineArmesUtilisees = "Lance,Hache", Citation = "I'm trembling with anticipation!", SourceImagePrincipal = "Artwork pour le jeu Fire Emblem Cipher par Mineri.",  LienSourceImage = "https://fireemblem.fandom.com/wiki/Wallace/Gallery?file=B21-060HN_artwork.png" },

                new Personnage() { Id = 5, IdParent = 2, Nom = "Eliwood", StatsDeBaseTotaux = 101, PersonnageVedette = true, ChaineClasses = "Lord,Knight Lord", ChaineArmesUtilisees = "Épée,Lance", Citation = "I know that I've caused much pain for my friends. But that is why... I will not lose here today!!", SourceImagePrincipal = "Artwork pour le jeu Fire Emblem Cipher par Sachiko Wada.",  LienSourceImage = "https://serenesforest.net/2016/11/11/cipher-s7-weekly-recap-new-reveals-and-text-free-artwork/" },

                new Personnage() { Id = 6, IdParent = 2, Nom = "Marcus", StatsDeBaseTotaux = 101, PersonnageVedette = false, ChaineClasses = "Paladin", ChaineArmesUtilisees = "Épée,Lance,Hache", Citation = "I'll show you the strength of a knight of Pherae.", SourceImagePrincipal = "Artwork pour le jeu Fire Emblem Cipher par Sachie.",  LienSourceImage = "https://fireemblem.fandom.com/wiki/Marcus/Gallery?file=S10-005ST_artwork.png" },

                new Personnage() { Id = 7, IdParent = 2, Nom = "Lowen", StatsDeBaseTotaux = 101,PersonnageVedette = false, ChaineClasses = "Cavalier,Paladin", ChaineArmesUtilisees = "Épée,Lance,Hache", Citation = "Knights should fight, not speak! ...Was that right?", SourceImagePrincipal = "Artwork pour le jeu Fire Emblem Cipher par Matsun (まっつん).",  LienSourceImage = "https://fireemblem.fandom.com/wiki/Lowen?file=B13-018N_artwork.png#Fire_Emblem_0_(Cipher)" },

                new Personnage() { Id = 8, IdParent = 2, Nom = "Isadora", StatsDeBaseTotaux = 101, PersonnageVedette = false, ChaineClasses = "Paladin", ChaineArmesUtilisees = "Épée,Lance,Hache", Citation = "My pride shall not be broken! My strength holds true!", SourceImagePrincipal = "Image créee par intelligence artificiel, généré par la demande de l'utilisateur LordOtako sur Civitai.",  LienSourceImage = "https://civitai.com/images/2730039" },

                new Personnage() { Id = 9, IdParent = 3, Nom = "Hector", StatsDeBaseTotaux = 101, PersonnageVedette = true, ChaineClasses = "Lord,Great Lord", ChaineArmesUtilisees = "Hache,Épée", Citation = "Me? Don't worry about me. I'm fine. I'm built tough, you know. A little too much is just enough for me.", SourceImagePrincipal = "Image créee par intelligence artificiel sur PixAI.",  LienSourceImage = "https://pixai.art/model/1678066113063153096?lang=fr" },

                new Personnage() { Id = 10, IdParent = 3, Nom = "Matthew", StatsDeBaseTotaux = 101, PersonnageVedette = false, ChaineClasses = "Thief,Assassin", ChaineArmesUtilisees = "Épée", Citation = "Let me handle this! There is much I can do.", SourceImagePrincipal = "Fanart sur Deviantart.com par Fishenode.",  LienSourceImage = "https://www.deviantart.com/fishenod/art/Ositia-s-Best-392523031" },

                new Personnage() { Id = 11, IdParent = 3, Nom = "Serra", StatsDeBaseTotaux = 101, PersonnageVedette = false, ChaineClasses = "Cleric,Bishop", ChaineArmesUtilisees = "Bâton de guérison", Citation = "Blessed Saint Elimine, grant us the strength to win this with ease.", SourceImagePrincipal = "Artwork pour le jeu Fire Emblem Cipher par 40hara.",  LienSourceImage = "https://fireemblem.fandom.com/wiki/Serra/Gallery?file=B07-018N_artwork.png" },

                new Personnage() { Id = 12, IdParent = 3, Nom = "Oswin", StatsDeBaseTotaux = 101, PersonnageVedette = false, ChaineClasses = "Knight,General", ChaineArmesUtilisees = "Lance,Hache", Citation = "For the honor of the knights of Ostia.", SourceImagePrincipal = "Artwork pour le jeu Fire Emblem Cipher par Yoneko.",  LienSourceImage = "https://fireemblem.fandom.com/wiki/Oswin?file=B07-027N_artwork.png" }
            };
