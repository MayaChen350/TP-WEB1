    ...
    public class BaseDeDonnees
    {
        ...
        public BaseDeDonnees()
        {
            ...
            Personnages = new List<Personnage>
            {
                ...
                new Personnage() { Id = 3, IdParent = 1, Nom = "Kent", PersonnageVedette = false, ChaineClasses = "Cavalier,Paladin", ChaineArmesUtilisees = "Épée,Lance,Hache", Citation = "I will gladly volunteer to protect Lycia with my life.", SourceImagePrincipal = "FArtwork #4 officiel de Fire Emblem 7 venant du jeu, découpé sur Kent.",  LienSourceImage = "https://serenesforest.net/blazing-sword/miscellaneous/cgs/" },
